...
command.prototype.initialize = function(plugin, callback) {
    ...
    // Write crash log
    if (opts.log) {
        // TODO: this may potentially interfere with the auto-closing CopyTask
    ...
    Step(function() {
        ...
        process.stderr.write('Localizing project...');
...
// command.prototype.toConsole = function(stats) {
